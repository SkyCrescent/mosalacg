...
export default function AddReservation({NumReservation ,SetReservation,handleClickButton8}){
   ...
   return(
      ...
      <>
         ...
         >
            <div className="w-full h-full md:h-[93%] lg:h-[83%]   flex justify-center my-12 md:my-6 lg:my-10">
               <div
                   className={` relative  flex justify-evenly hidden md:hidden lg:block h-[100%] md:h-[100%] w-[98%] md:w-[80%] bg-white border border-black/70  shadow   ${loading ? 'scale-x-100 scale-y-100 opacity-100' : 'scale-x-0 scale-y-0 opacity-0'}  transition duration-500    `}>
               ...
               <div className="w-full h-full block md:block lg:hidden flex justify-center items-center p-4 md:p-1">
                  <div
                      className="relative flex flex-col lg:flex-row justify-center w-full md:h-[90%] max-w-4xl bg-white border border-black/70 shadow-lg transition duration-500 ease-in-out">

                     {/* Bouton de Fermeture */}
                     <div className="absolute z-10 top-64 md:top-16 right-4">
                        <img
                            src={close.src}
                            alt="Fermer"
                            className="h-12 w-12 md:h-28 md:w-28 cursor-pointer"
                     ...
                     <div
                         className="flex flex-col sm:flex-row  items-center lg:items-start text-center  lg:text-left p-4 space-y-4 lg:space-y-8 w-full lg:w-1/3">
                        <div className="space-y-2 ">
                           <h4 className="text-lg mt-36 md:mt-2 font-medium text-green-700">Réservation</h4>
                        </div>
                     ...
                     {/* Formulaire */}
                     <div className="flex flex-col sm:flex-row items-center p-4 w-full h-full border border-black lg:w-2/3">
                        {/* Colonne 1 */}
